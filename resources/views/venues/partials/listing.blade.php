<div class="d-flex justify-between align-center mb-4">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-secondary w-full sm:w-auto" onclick="document.querySelector('.filters-card').style.display = 'block'"><i class="fas fa-filter"></i> Filters</button>
    </div>
</div>
...
<div class="venue-listing mb-5">
    ...
    <div class="card" style="transition:var(--transition)">
        <div style="position:relative; aspect-ratio:16/10; overflow:hidden; border-bottom:1px solid var(--border)">
            <a href="{{ route('venues.show', $venue) }}">
                <img class="w-full h-auto object-cover w-full h-auto object-cover" src="{{ $venue->first_image }}" alt="{{ $venue->name }}" style="width:100%; height:100%; object-fit:cover;">
            </a>
        ...
        <div class="card-body p-3">
            ...
            <div class="d-flex justify-between align-center border-top pt-3" style="border-top:1px solid var(--border-strong);">
                ...
                <div class="d-flex gap-2">
                    @can('update', $venue)
                        <a href="{{ route('venues.edit', $venue) }}" class="btn btn-outline btn-sm w-full sm:w-auto" style="padding: 0.25rem 0.5rem; font-size: 0.8rem;">Edit</a>
                    ...
                    @endcan
                    <a href="{{ route('venues.show', $venue) }}" class="btn btn-primary w-full sm:w-auto" style="padding: 0.25rem 0.75rem; font-size: 0.8rem;">Book Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="grid-column:1/-1; padding:4rem; text-align:center;">
        ...
        <button type="button" class="btn btn-primary w-full sm:w-auto" onclick="resetFilters()">Clear Filters</button>
    </div>
    @endforelse
</div>

<div class="d-flex justify-center mt-5 pagination-container mx-auto px-4">
